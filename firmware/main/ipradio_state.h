...
typedef enum {
    ...
    IPRADIO_EV_TUNE_DELTA,        /**< поворот регулятора 1, arg = ±шаги      */
    /* Внимание: TUNE_DELTA - это ПЕРЕБОР СТАНЦИЙ, а не перестройка
     * частоты. Так задано в §6.1: на экране воспроизведения регулятор 1
    ...
    IPRADIO_EV_SELECT,            /**< короткое нажатие регулятора 1          */
    IPRADIO_EV_MENU,              /**< долгое нажатие регулятора 1            */
 ...
 *
 *  Нужен ровно для одного: пока на экране висит диалог, регулятор 1
