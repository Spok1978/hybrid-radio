...
typedef struct {
     ...
     * над всем прибором, а не над его состоянием. Флаг видит мост
     * в app_main и делает остальное - глушит звук, гасит подсветку,
     * сохраняет настройки и уводит кристалл в глубокий сон. */
    bool                 power_off;
} ipradio_snapshot_t;
