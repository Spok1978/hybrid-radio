 ...
 *
 *     энкодер 1, вращение   — перемещение по строкам
 *     энкодер 1, нажатие    — вход в пункт
 *     энкодер 2, нажатие    — выход на уровень вверх
 *
 * Кнопка энкодера 2 — это mute на экране воспроизведения, и здесь она
