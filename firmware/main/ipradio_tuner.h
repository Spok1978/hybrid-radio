 ...
 *  ЗАПАС: никем не вызывается - частоту считает автомат. */
/* ЗАПАС: не вызывается — частоту считает автомат и ставит её
 * через set_freq. Оставлено на случай ручной перестройки. */
