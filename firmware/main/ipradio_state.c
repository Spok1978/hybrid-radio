...
{
    /* Поворот регулятора снимает mute и сразу выставляет уровень (§6.3):
...
/* Перебор сохранённых станций регулятором 1 (§6.1).
 *
...
static void state_task(void *arg)
{
    ...
    for (;;) {
         ...
         * Он может забрать событие себе: пока висит диалог, регулятор 1
